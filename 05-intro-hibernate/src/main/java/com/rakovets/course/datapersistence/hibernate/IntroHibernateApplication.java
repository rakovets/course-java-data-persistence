package com.rakovets.course.datapersistence.hibernate;

import com.rakovets.course.datapersistence.hibernate.dal.entity.Employee;
...
public class IntroHibernateApplication {
    public static void main(String[] args) {
        ...
        List<Employee> findEmployee = session.createNativeQuery("SELECT * FROM employee WHERE employee_id = 2", Employee.class)
                .getResultList();
